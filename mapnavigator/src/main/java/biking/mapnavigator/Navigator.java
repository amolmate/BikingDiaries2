...
public class Navigator {
	...
	private class PathCreator extends AsyncTask<Void,Void,Directions>{
		...
		protected void onPostExecute(Directions directions){
			...
			if(directions != null){
				...
				iGetDistTime.getDistTime(directions.getDuration(), directions.getDistance());
				if(listener != null){
	...
	return	Navigator.this.directions.getDistance();
	}
	
	public String getDuration(){
		return	Navigator.this.directions.getDuration();
		}
}
