			...
			if(!obj3.isNull("legs")){
				...
				for(int i=0; i<leg.length();i++){
					...
					if(i == 0){
						...
						JSONObject objDuration = obj.getJSONObject("duration");
							
							totalDuration = objDuration.getString("text");
						
						
						
							JSONObject objDistance = obj.getJSONObject("distance");
							
							totalDistance = objDistance.getString("text");
						
						Log.d("Route","Duration:"+totalDuration);
						Log.d("Route","Distance:"+totalDistance);
					}
